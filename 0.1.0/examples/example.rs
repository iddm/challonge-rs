...
fn main() {
    ...
    println!("Check-in process result: {:?}", c.tournament_process_checkins(TournamentId::Url("subdomain".to_owned(), "test1".to_owned()), true, true));
    println!("Check-in abort result: {:?}", c.tournament_abort_checkins(TournamentId::Url("subdomain".to_owned(), "test1".to_owned()), true, true));
    println!("Start result: {:?}", c.tournament_start(TournamentId::Url("subdomain".to_owned(), "test1".to_owned()), true, true));
    println!("Finalize result: {:?}", c.tournament_finalize(TournamentId::Url("subdomain".to_owned(), "test1".to_owned()), true, true));
    println!("Reset result: {:?}", c.tournament_reset(TournamentId::Url("subdomain".to_owned(), "test1".to_owned()), true, true));
